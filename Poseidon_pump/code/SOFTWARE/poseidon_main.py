...
class Thread(QtCore.QThread):
	def __init__(self, fn, *args, **kwargs):
		...
		self.correction_factor = 0.9388138339773648  # dla pompy 1
...
class MainWindow(QtWidgets.QMainWindow, poseidon_controller_gui.Ui_MainWindow):
	...
	def convert_displacement(self, displacement, units, syringe_area, microsteps):
		...
		# zmiana parametru kalibrujacego
		correction_parameter = 0.9311019628300378
		displacement = displacement / correction_parameter
